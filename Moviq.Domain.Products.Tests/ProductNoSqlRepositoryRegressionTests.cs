namespace Moviq.Domain.Products.Tests
{
    ...
    public class ProductNoSqlRepositoryRegressionTests
    {
        ...
        [TestMethod]
        [TestCategory("(Regression) ProductNoSqlRepository, when Set is executed with valid data, it")]
        ...
        [TestMethod]
        [TestCategory("(Regression) ProductNoSqlRepository, when Get is executed with a valid Id, it")]
        ...
        //[TestMethod]
        //[TestCategory("(Regression) ProductNoSqlRepository, when List is executed")]
        ...
        [TestMethod]
        [TestCategory("(Regression) ProductNoSqlRepository, when Find is executed with valid search criteria, it")]
        ...
        [TestMethod]
        [TestCategory("(Regression) ProductNoSqlRepository, when Find is executed with advanced search criteria, it")]
